 ...
 */
public class Aftercare24MonthFragment extends BaseSonFragment implements View.OnClickListener {
    private final String TAG = Aftercare24MonthFragment.class.getSimpleName();
